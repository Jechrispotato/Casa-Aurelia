...
<div class="min-h-screen flex items-center justify-center bg-gray-950 py-12 px-4 sm:px-6 lg:px-8 relative font-sans">
    ...
    <div
        ...
        <div class="w-full md:w-1/2 p-10 md:p-14 lg:p-16 flex flex-col justify-center bg-gray-900 relative">
            ...
            <form class="space-y-6" action="process/process_login.php" method="POST" id="loginForm" novalidate>
                ...
                <p class="text-xs text-gray-500 text-center mt-8">
                    By signing up, you agree to our <a href="../pages/terms.php" class="underline hover:text-gray-400">Terms</a>
                    and <a href="../pages/privacy.php" class="underline hover:text-gray-400">Privacy Policy</a>.
                </p>
            </form>
        </div>
