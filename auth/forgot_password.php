    ...
    <div
        ...
        <div class="w-full md:w-1/2 p-10 md:p-14 lg:p-16 flex flex-col justify-center bg-gray-900 relative">
            <div class="mb-10">
                ...
                <p class="text-gray-400 text-lg">Enter your email address and we'll send you a link to reset your
                    password.</p>
            </div>
            ...
            <form class="space-y-6" action="process/process_forgot_password.php" method="POST" id="forgotPasswordForm"
                novalidate>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-red-500 hidden font-medium ml-1" id="emailError"></p>
                    </div>
                </div>
        ...
        <div class="hidden md:block w-1/2 relative bg-gray-900 overflow-hidden border-l border-gray-800">
            ...
            <div class="absolute bottom-16 left-12 right-12 z-20">
                <div class="bg-gray-900/40 backdrop-blur-xl rounded-3xl p-8 border border-white/5 shadow-2xl">
                    ...
                    <h3 class="text-white font-serif text-2xl font-bold mb-3 tracking-tight">Concierge Support</h3>
                    <p class="text-gray-300 font-serif text-lg leading-relaxed italic opacity-90">"Your digital security
                        is as important to us as your comfort during your stay."</p>
                </div>
            </div>
        </div>
    </div>
