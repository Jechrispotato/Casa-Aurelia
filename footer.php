        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div class="left-panel flex flex-col items-center text-center space-y-6">
                <a href="index.php" class="block">
                    <img src="<?php echo $is_admin_page ? '../' : ''; ?>/aurelia_assets/aurelia_main_logo_only_white.png"
            ...
            <!-- Newsletter -->
            <div>
                <h4 class="footer-headers text-white font-bold mb-6 text-lg">Newsletter</h4>
...
<style>
    ...
    body {
        font-family: 'AureliaLight', sans-serif;
    }
