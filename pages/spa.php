...
<section class="parallax-hero h-[80vh] flex items-center justify-center relative overflow-hidden">
    ...
    <div class="text-center relative z-10 p-6 reveal active delay-100">
        ...
        <p class="text-gray-200 text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed mb-10">
            Escape the ordinary and embark on a journey of relaxation. Restore your mind, body, and spirit in our
...
<!-- Intro & Philosophy -->
<section id="intro" class="py-24 bg-gray-900 relative">
    <div class="container mx-auto px-4 max-w-6xl">
        <div class="flex flex-col md:flex-row items-center gap-16 reveal">
            <div class="w-full md:w-1/2 relative">
                <div class="absolute -top-4 -left-4 w-20 h-20 bg-yellow-900/20 rounded-full z-0"></div>
                <div class="absolute -bottom-4 -right-4 w-32 h-32 bg-yellow-950/20 rounded-full z-0"></div>
                <img src="../images/spa.jpg" alt="Spa Interior"
                    class="relative z-10 rounded-3xl shadow-2xl object-cover w-full h-[500px]">
            </div>
            <div class="w-full md:w-1/2">
                <span class="text-yellow-600 font-bold tracking-widest uppercase text-sm">Our Philosophy</span>
                <h2 class="text-4xl md:text-5xl font-serif mt-4 mb-6 text-white">Holistic Harmony</h2>
                <div class="w-20 h-1 bg-yellow-500 mb-8"></div>
                <p class="text-gray-400 text-lg leading-relaxed mb-6 font-light">
                    At The Grand Aurelia Spa, we believe in the power of holistic wellness. Our carefully crafted
                    treatments combine ancient techniques with modern luxury to provide an experience that nurtures both
                    body and soul.
                </p>
                <div class="grid grid-cols-2 gap-6 mt-8">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-12 h-12 rounded-full bg-yellow-900/30 flex items-center justify-center text-yellow-500">
                            <i class="fas fa-leaf text-xl"></i>
                        </div>
                        <span class="font-medium text-white">Organic Products</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div
                            class="w-12 h-12 rounded-full bg-yellow-900/30 flex items-center justify-center text-yellow-500">
                        ...
                        <span class="font-medium text-white">Expert Therapists</span>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-20 bg-gray-900">
    <div class="container mx-auto px-4 max-w-7xl">
        <div class="text-center mb-16 reveal">
            <h2 class="text-4xl font-serif text-white">World-Class Facilities</h2>
            <p class="text-gray-400 mt-3 font-light">Complimentary access for all hotel guests</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div
                class="bg-gray-800 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 reveal">
                <i class="fas fa-swimming-pool text-4xl text-yellow-500 mb-6"></i>
                <h3 class="text-xl font-bold text-white mb-3">Indoor Pool</h3>
                <p class="text-gray-400 text-sm">Temperature-controlled lap pool with hydrotherapy jets for ultimate
                    relaxation.</p>
            </div>
            <div
                class="bg-gray-800 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 reveal delay-100">
                <i class="fas fa-hot-tub text-4xl text-yellow-500 mb-6"></i>
                <h3 class="text-xl font-bold text-white mb-3">Jacuzzi</h3>
                <p class="text-gray-400 text-sm">Luxurious hot tubs featuring panoramic skyline views.</p>
            </div>
            <div
                class="bg-gray-800 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 reveal delay-200">
                <i class="fas fa-wind text-4xl text-yellow-500 mb-6"></i>
                <h3 class="text-xl font-bold text-white mb-3">Sauna & Steam</h3>
                <p class="text-gray-400 text-sm">Traditional Finnish sauna and aromatic steam rooms to detoxify.</p>
            </div>
            <div
                class="bg-gray-800 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 reveal delay-300">
                <i class="fas fa-dumbbell text-4xl text-yellow-500 mb-6"></i>
                <h3 class="text-xl font-bold text-white mb-3">Fitness Center</h3>
                <p class="text-gray-400 text-sm">State-of-the-art gym equipment open 24 hours for your convenience.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-24 bg-gray-900">
    <div class="container mx-auto px-4 max-w-6xl">
        <div class="text-center mb-16 reveal">
            ...
            <h2 class="text-4xl md:text-5xl font-serif mt-3 text-white">Signature Treatments</h2>
        </div>

        <!-- Massages -->
        <h3 class="text-2xl font-serif text-white mb-8 border-l-4 border-yellow-500 pl-4 reveal">Massage Therapy</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <?php foreach ($spa_treatments as $treatment): ?>
                <div
                    class="flex flex-col md:flex-row bg-gray-800 rounded-2xl overflow-hidden shadow-lg border border-gray-700 card-hover reveal">
                    ...
                    <div class="p-8 md:w-3/5 flex flex-col justify-between">
                        <div>
                            <div class="flex justify-between items-start mb-2">
                                <h4 class="text-xl font-bold text-white font-serif"><?php echo $treatment['name']; ?></h4>
                            ...
                            <p class="text-gray-400 text-sm"><?php echo $treatment['description']; ?></p>
                        </div>
                        <button onclick="bookTreatment('<?php echo $treatment['name']; ?>')"
                            class="mt-6 w-full py-3 border border-gray-700 text-white rounded-lg hover:bg-white hover:text-gray-900 transition-all text-sm font-bold uppercase tracking-wider">
                            Book This
                        </button>
                    </div>
                </div>
        ...
        <!-- Facials -->
        <h3 class="text-2xl font-serif text-white mb-8 border-l-4 border-yellow-500 pl-4 reveal">Facial Treatments</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <?php foreach ($facial_treatments as $facial): ?>
                <div
                    class="flex flex-col md:flex-row bg-gray-800 rounded-2xl overflow-hidden shadow-lg border border-gray-700 card-hover reveal">
                    <div class="md:w-2/5 h-64 md:h-auto overflow-hidden">
                        <img src="<?php echo $facial['image']; ?>" alt="<?php echo $facial['name']; ?>"
                            class="w-full h-full object-cover transform hover:scale-110 transition-transform duration-700">
                    </div>
                    <div class="p-8 md:w-3/5 flex flex-col justify-between">
                        <div>
                            <div class="flex justify-between items-start mb-2">
                                <h4 class="text-xl font-bold text-white font-serif"><?php echo $facial['name']; ?></h4>
                                <span class="text-yellow-600 font-bold text-lg"><?php echo $facial['price']; ?></span>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-gray-400 mb-4">
                                <i class="far fa-clock"></i> <?php echo $facial['duration']; ?>
                            </div>
                            <p class="text-gray-400 text-sm"><?php echo $facial['description']; ?></p>
                        </div>
...
<section class="py-24 bg-gray-900 text-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Pkg 1 -->
            <div
                class="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-8 hover:bg-gray-800 transition-all card-hover reveal">
                ...
                <ul class="space-y-4 mb-8 text-gray-300 text-sm">
                    <li class="flex items-center gap-3"><i class="fas fa-check text-yellow-500"></i> 60-min Swedish
                        Massage</li>
                    <li class="flex items-center gap-3"><i class="fas fa-check text-yellow-500"></i> Hydrating Facial
                    </li>
                    <li class="flex items-center gap-3"><i class="fas fa-check text-yellow-500"></i> Aromatherapy Scrub
                    </li>
                    <li class="flex items-center gap-3"><i class="fas fa-check text-yellow-500"></i> Spa Lunch</li>
                </ul>
                <button onclick="bookTreatment('Relaxation Package')"
                    class="custom-btn-yellow-hover w-full py-3 bg-white text-gray-900 rounded-full font-bold transition-colors">Select
                    Package</button>
            </div>

            <!-- Pkg 2 (Featured) -->
            <div
                class="bg-yellow-600 rounded-3xl p-8 transform md:-translate-y-4 shadow-2xl relative card-hover reveal delay-100">
                <div
                    class="absolute top-0 right-0 bg-white text-yellow-800 text-xs font-bold px-3 py-1 rounded-bl-lg rounded-tr-lg">
                    POPULAR</div>
                ...
                <ul class="space-y-4 mb-8 text-white text-sm">
                    <li class="flex items-center gap-3"><i class="fas fa-star text-white"></i> 90-min Hot Stone Massage
                    </li>
                ...
                <button onclick="bookTreatment('Renewal Package')"
                    class="custom-btn-hover w-full py-3 bg-gray-900 text-white rounded-full font-bold hover:bg-white transition-colors shadow-lg">Select
                    Package</button>
            </div>

            <!-- Pkg 3 -->
            <div
                class="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-8 hover:bg-gray-800 transition-all card-hover reveal delay-200">
                <div class="text-center border-b border-gray-700 pb-6 mb-6">
                ...
                <ul class="space-y-4 mb-8 text-gray-300 text-sm">
                    <li class="flex items-center gap-3"><i class="fas fa-check text-yellow-500"></i> Couples Massage
                    </li>
                    <li class="flex items-center gap-3"><i class="fas fa-check text-yellow-500"></i> Private Jacuzzi
                    </li>
                    <li class="flex items-center gap-3"><i class="fas fa-check text-yellow-500"></i> Mini Facials</li>
                    <li class="flex items-center gap-3"><i class="fas fa-check text-yellow-500"></i> Strawberries & Wine
                    </li>
                </ul>
                <button onclick="bookTreatment('Couples Retreat')"
                    class="custom-btn-yellow-hover w-full py-3 bg-white text-gray-900 rounded-full font-bold transition-colors">Select
                    Package</button>
            </div>
        </div>
...
<section id="spa-reserve" class="py-24 bg-gray-900">
    <div class="container mx-auto px-4 max-w-4xl">
        <div class="dark-glass p-8 md:p-12 rounded-3xl shadow-2xl reveal">
            <div class="text-center mb-10">
                <h2 class="text-3xl font-serif text-white font-bold">Book Your Appointment</h2>
                <p class="text-gray-400 mt-2">Reserve your moment of tranquility</p>
            </div>
            ...
            <form action="../reservations/process/process_spa_reservation.php" method="POST" id="spaForm" class="space-y-6">
                <!-- CSRF Token -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1">Full Name</label>
                        <div class="relative">
                    ...
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1">Email
                            Address</label>
                        <div class="relative">
                            <i
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1">Treatment /
                            Package</label>
                        <div class="relative">
                            <i class="fas fa-spa absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
                            <select id="treatment-select" name="treatment" required
                                class="w-full pl-10 pr-4 py-3 bg-gray-800 border border-gray-700 text-white rounded-xl focus:border-yellow-500 focus:ring-2 focus:ring-yellow-900 outline-none transition-all appearance-none cursor-pointer">
                                <option value="">Select Experience</option>
                                <optgroup label="Massages">
                                    <?php foreach ($spa_treatments as $t)
                                        echo '<option value="' . htmlspecialchars($t['name']) . '">' . htmlspecialchars($t['name']) . '</option>'; ?>
                                </optgroup>
                                <optgroup label="Facials">
                                    <?php foreach ($facial_treatments as $f)
                                        echo '<option value="' . htmlspecialchars($f['name']) . '">' . htmlspecialchars($f['name']) . '</option>'; ?>
                                </optgroup>
                    ...
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1">Date</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1">Time</label>
                        <div class="relative">
                            <i
                    ...
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1">Number of
                            Guests</label>
                        <select name="guests" required
                            class="w-full px-4 py-3 bg-gray-800 border border-gray-700 text-white rounded-xl focus:border-yellow-500 focus:ring-2 focus:ring-yellow-900 outline-none transition-all">
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                ...
                <div class="space-y-2">
                    <label class="text-xs font-bold text-gray-400 uppercase tracking-wide ml-1">Special Requests</label>
                    <textarea name="special_requests" rows="3"
                        placeholder="Any health conditions, allergies, or therapist preferences..."
                ...
                <div class="pt-4 text-center">
                    ...
                    <?php else: ?>
                        <a href="../auth/login.php?redirect=pages/spa.php&notify=please_login"
                        ...
                        <p class="mt-4 text-sm text-gray-400">You must be logged in to book an appointment.</p>
                    <?php endif; ?>
                </div>
            </form>
        </div>
