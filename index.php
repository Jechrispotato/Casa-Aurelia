...
<div class="relative h-screen min-h-[400px] flex items-center justify-center overflow-hidden ">
    ...
    <div class="absolute inset-0 z-0">
        <img src="images/background.jpg" alt="Luxury Hotel" class=" bg_index w-full h-full object-cover transform scale-105 animate-slow-zoom">
...
<section class="py-20 bg-gray-900 text-white relative overflow-visible">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <!-- Feature 1 -->
            <div class="ameneties_box group p-8 rounded-2xl bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 hover:bg-gray-800 hover:border-yellow-500/30 transition-all duration-300 hover:-translate-y-2 reveal">
                ...
                <p class="ameneties_description text-gray-400 text-sm leading-relaxed">Stay seamlessly connected with our complimentary premium internet access throughout the property.</p>
            </div>
            ...
            <div class="ameneties_box group p-8 rounded-2xl bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 hover:bg-gray-800 hover:border-yellow-500/30 transition-all duration-300 hover:-translate-y-2 reveal">
                ...
                <p class="ameneties_description text-gray-400 text-sm leading-relaxed">Indulge in exquisite culinary masterpieces at our award-winning fine dining restaurants.</p>
            </div>
            ...
            <div class="ameneties_box group p-8 rounded-2xl bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 hover:bg-gray-800 hover:border-yellow-500/30 transition-all duration-300 hover:-translate-y-2 reveal">
                ...
                <p class="ameneties_description text-gray-400 text-sm leading-relaxed">Rejuvenate your senses with our world-class treatments and wellness facilities.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-12 mb-20 appear autoblur_image">
            <div class="lg:w-1/2 relative group">
                ...
                <img src="images/dining.jpg" alt="Fine Dining" class="relative rounded-2xl shadow-2xl w-full object-cover h-[400px] transform transition-transform duration-500 group-hover:scale-[1.01] slide-in-left">
            </div>
            <div class="lg:w-1/2 space-y-6 text-left slide-in-right">
                <h3 class="text-yellow-500 font-medium tracking-widest text-sm uppercase reveal ">Culinary Excellence</h3>
                ...
                <ul class="space-y-3 text-gray-300">
                    <li class="flex items-center gap-3 reveal"><i class="fas fa-check text-yellow-500"></i> Farm-to-table ingredients</li>
        ...
        <div class="flex flex-col lg:flex-row-reverse items-center gap-12 autoblur_image">
            ...
            <div class="lg:w-1/2 relative group">
                ...
                <img src="images/spa.jpg" alt="Aurelia Spa" class="relative rounded-2xl shadow-2xl w-full object-cover h-[400px] transform transition-transform duration-500 group-hover:scale-[1.01] slide-in-right">
            </div>
            <div class="lg:w-1/2 space-y-6 text-left lg:text-right flex flex-col items-start lg:items-end slide-in-left">
                <h3 class="text-yellow-500 font-medium tracking-widest text-sm uppercase reveal">Wellness & Serenity</h3>
...
<section class="accomodation py-24 bg-gray-50">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <!-- Room 1 -->
            <div class="group bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 slide-in-center-left">
                <div class="relative h-72 overflow-hidden">
                    <div class="room_price absolute top-4 right-4 z-10  font-bold px-4 py-2 rounded-full shadow-lg group-hover:bg-gray-900 group-hover:text-white transition-all duration-300">
                        ₱1,500<span class="room_price text-sm font-normal text-gray-600 group-hover:bg-gray-900 group-hover:text-white transition-all duration-300">/night</span>
                    </div>
                ...
                <div class="p-8">
                    ...
                    <div class="room_details flex items-center gap-4 text-sm text-gray-500 mb-6 border-t border-gray-100 pt-6">
            ...
            <!-- Room 2 -->
            <div class="group bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 reveal">
                <div class="relative h-72 overflow-hidden">
                    <div class="room_price absolute top-4 right-4 z-10  font-bold px-4 py-2 rounded-full shadow-lg group-hover:bg-gray-900 group-hover:text-white transition-all duration-300 group-hover:bg-gray-900 group-hover:text-white transition-all duration-300">
                        ₱350<span class="room_price text-sm font-normal text-gray-600 group-hover:bg-gray-900 group-hover:text-white transition-all duration-300">/night</span>
                    </div>
            ...
            <!-- Room 3 -->
            <div class="group bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 reveal slide-in-center-right">
                <div class="relative h-72 overflow-hidden">
                    <div class="room_price absolute top-4 right-4 z-10  font-bold px-4 py-2 rounded-full shadow-lg group-hover:bg-gray-900 group-hover:text-white transition-all duration-300">
                        ₱400<span class="room_price text-sm font-normal text-gray-600 group-hover:bg-gray-900 group-hover:text-white transition-all duration-300">/night</span>
                    </div>
                ...
                <div class="carousel-group">
                    ...
                    <div class="review-card bg-white p-8 rounded-2xl shadow-lg border border-gray-100 relative">
                        ...
                        <p class="text-gray-600 italic mb-6">
                            "Amazing experience! The staff was incredibly helpful and the room exceeded our expectations in every way."
                        </p>
                    ...
                    <div class="review-card bg-white p-8 rounded-2xl shadow-lg border border-gray-100 relative">
                        ...
                        <p class="text-gray-600 italic mb-6">
                            "Perfect location, luxurious rooms, and outstanding service. The dining experience was absolute perfection."
                        </p>
                        <div class="border-t border-gray-100 pt-6">
                    ...
                    <div class="review-card bg-white p-8 rounded-2xl shadow-lg border border-gray-100 relative">
                        ...
                        <p class="text-gray-600 italic mb-6">
                            "The attention to detail and customer service made our stay truly memorable. The spa is a must-try!"
                        </p>
                        <div class="border-t border-gray-100 pt-6">
...
<section class="py-20 relative overflow-hidden flex items-center justify-center">
    ...
    <div class="absolute inset-0">
        <img src="images/background.jpg" alt="Background" class="w-full h-full object-cover filter brightness-[0.3] absolute inset-0">
