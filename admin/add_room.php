        ...
        <div class="bg-gray-900 rounded-2xl shadow-sm border border-gray-800 overflow-hidden">
            <div class="p-8">
                ...
                <form method="POST" action="add_room.php">
                    ...
                    <div class="mb-6">
                        <label for="room_image" class="block text-sm font-bold text-gray-400 mb-2">Image Filename</label>
                        <input type="text" name="room_image" id="room_image"
                            class="w-full px-4 py-3 rounded-xl bg-gray-800 border border-gray-700 text-white focus:border-yellow-600 focus:ring-2 focus:ring-yellow-900 outline-none transition-all placeholder-gray-600"
                            placeholder="e.g. room.jpg">
                        <p class="mt-2 text-xs text-gray-500">Enter the filename of an image present in the <code
                                class="bg-gray-800 px-1 py-0.5 rounded text-gray-400">images</code> folder.</p>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-800">
                        ...
                        <button type="submit"
                            class="px-8 py-3 bg-yellow-600 text-white font-bold rounded-xl shadow-lg shadow-yellow-600/20 hover:bg-yellow-700 transform hover:-translate-y-0.5 transition-all">
                            Create Room
                        </button>
                    </div>
                </form>
