    ...
    <div class="overflow-x-auto">
                        ...
                        <tr class="hover:bg-gray-800/50 transition-colors group">
                            ...
                            <td class="p-4">
                                <div class="text-sm text-white">
                                    <?php echo isset($booking['reservation_date']) ? date('M d, Y', strtotime($booking['reservation_date'])) : '-'; ?>
                                </div>
                                <div class="text-xs text-gray-400">
                                    <?php echo isset($booking['reservation_time']) ? date('g:i A', strtotime($booking['reservation_time'])) : '-'; ?>
                                </div>
                            </td>
                            <td class="p-4 text-sm text-gray-400"><?php echo htmlspecialchars($booking['number_of_guests']); ?>
                            </td>
                            <td class="p-4 text-sm font-medium text-gray-300">
                                <?php echo htmlspecialchars($booking['venue'] ?? 'Not specified'); ?>
                            </td>
                            <td class="p-4">
                                <span
        ...
        <?php else: ?>
            <div class="p-12 text-center">
                ...
                <p class="text-gray-400 font-medium">No reservations found matching your criteria.</p>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.body.addEventListener('click', function (e) {
            ...
            const action = isApprove ? 'confirmed' : 'cancelled'; // Dining status logic
            ...
            if (isApprove) {
                ...
                modalMessage.textContent = 'Are you sure you want to confirm this dining reservation?';
                ...
                modalMessage.textContent = 'Are you sure you want to cancel this dining reservation?';
        ...
        confirmBtn.addEventListener('click', async function () {
            ...
            try {
                const response = await fetch('update_dining_booking.php', {
                    ...
                    body: `reservation_id=${bookingId}&status=${status}` // Notice: reservation_id
                });
