...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="mb-6">
        <a href="<?php echo ADMIN_PATH; ?>rooms.php"
            class="text-yellow-600 hover:text-yellow-700 flex items-center gap-2">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8">
        ...
        <form action="<?php echo ADMIN_PATH; ?>edit_room.php?id=<?php echo $room_id; ?>" method="POST"
            class="space-y-6">
            <!-- CSRF Token -->
            ...
            <div>
                ...
                <input type="text" name="room_name" id="room_name"
                    ...
                    value="<?php echo htmlspecialchars($room['room_name']); ?>" required maxlength="100">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="price" id="price"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-all"
                        value="<?php echo htmlspecialchars($room['price']); ?>" required min="0" step="0.01">
                </div>

                <div>
                    <label for="price_per_hour" class="block text-sm font-medium text-gray-700 mb-2">Price per Hour
                        ($)</label>
                    <input type="number" name="price_per_hour" id="price_per_hour"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-all"
                        value="<?php echo htmlspecialchars($room['price_per_hour'] ?? ''); ?>" min="0" step="0.01"
