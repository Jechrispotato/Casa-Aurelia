...
// Include security headers before any output
...
$is_admin_page = ($current_section === 'admin');
...
<head>
    ...
    <style>
        ...
        /* Aurelia Light for main text */
        @font-face {
            font-family: 'AureliaLight';
            src: url('<?php echo AURELIA_ASSETS; ?>sf-ui-display-light-58646b33e0551.otf') format('opentype');
            font-style: normal;
            font-display: swap;
        }
        ...
        <div class="container mx-auto px-4">
            ...
            <div id="mobileMenu" class="lg:hidden hidden pb-4">
                <div class="flex flex-col space-y-1 pt-2">
                    ...
                    <?php else: ?>
                        <a href="<?php echo AUTH_PATH; ?>login.php"
                    ...
                    <?php if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'admin'): ?>
                        <a href="<?php echo BOOKING_PATH; ?>add_booking.php"
